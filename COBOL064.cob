      ...
      *
      * ARQUIVO SAIDA 2
           SELECT OUTPTF2    ASSIGN TO OUTPTF2
           ORGANIZATION IS SEQUENTIAL
           ACCESS MODE IS SEQUENTIAL
           FILE STATUS IS FS-STATUS.
      *
      ...
      *
       ...
       77 WSS-REG-GRAVADO2   PIC 999 VALUE ZEROES.
      *
      ********************
       PROCEDURE DIVISION.
      ********************
           ...
           DISPLAY 'GRAVANDO EM DOIS ARQUIVOS'.
           ...
           DISPLAY '*******************************************'.
           DISPLAY '*** PROGRAMA COBOL064                   ***'.
           DISPLAY '*******************************************'.
           DISPLAY '* TERMINO DE PROCESSAMENTO OK             *'.
           DISPLAY '*                                         *'.
           DISPLAY '* REGISTRO LIDOS       : ' WSS-REG-LIDOS.
           DISPLAY '* REGISTRO GRAVADOS F1 : ' WSS-REG-GRAVADOS.
           DISPLAY '* REGISTRO GRAVADOS F2 : ' WSS-REG-GRAVADO2.
           DISPLAY '*******************************************'.
      ...
      * ARQUIVO DE SAIDA 2.
           ...
           IF FS-STATUS > 0
              DISPLAY 'ERRO NA ABERTURA DO ARQUIVO OUTPTF2 '
              DISPLAY 'FS-STATUS : ' FS-STATUS
              MOVE FS-STATUS    TO  RETURN-CODE
              PERFORM ROT-ABEND
           END-IF.
     ...
     *** MOVIMENTA REGISTROS PARA O ARQUIVO1
     ...
     *** MOVIMENTA REGISTROS PARA O ARQUIVO2
           ADD  01                 TO   WSS-REG-GRAVADO2.

           MOVE  'RUA ESPANHA  NUM. 11'  TO  REG-ENDERECO.
           MOVE  'NOVA ODESSA'           TO  REG-CIDADE.
           MOVE  'SP'                    TO  REG-ESTADO.
           MOVE  '13220-199'             TO  REG-CEP.

           MOVE  REG-DADOS         TO   REG-OUTPU2.
           WRITE REG-OUTPU2
           END-WRITE.
      ...
      * FECHA ARQUIVO SAIDA 2.
           CLOSE OUTPTF2.

           IF FS-STATUS > 0
              DISPLAY 'ERRO NO FECHAMENTO DO ARQUIVO OUTPTF2 '
              DISPLAY 'FS-STATUS : ' FS-STATUS
              MOVE FS-STATUS    TO  RETURN-CODE
              PERFORM ROT-ABEND
           END-IF.
