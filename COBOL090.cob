      ...
      *----                                                             00351000
       1000-OPEN-FUNCI.                                                 00352000
           ...
           IF ST-FUNCIN1 NOT EQUAL 0 THEN                               00354000
              DISPLAY 'COBOL090 - ERRO OPEN FUNCIN1 FS=' ST-FUNCIN1     00356000
              MOVE ST-FUNCIN1   TO RETURN-CODE
              PERFORM ROT-ABEND
                 THRU ROT-ABEND-EXIT
           END-IF.
           ...
           IF ST-FUNCIN2 NOT EQUAL 0 THEN                               00354000
              DISPLAY 'COBOL090 - ERRO OPEN FUNCIN2 FS=' ST-FUNCIN2     00356000
              MOVE ST-FUNCIN2   TO RETURN-CODE
              PERFORM ROT-ABEND
                 THRU ROT-ABEND-EXIT
           END-IF.
           ...
           IF ST-FUNCOUT NOT EQUAL 0 THEN                               00354000
              DISPLAY 'COBOL090 - ERRO OPEN FUNCOUT FS=' ST-FUNCOUT     00356000
      ...
      *----                                                             00358000
       1001-LER-FUNCIN1.                                                00359000
           ...
           IF ST-FUNCIN1 NOT EQUAL 0 AND WSS-EOF1 NOT = 'Y' THEN        00354000
              DISPLAY 'COBOL090 - ERRO READ FUNCI  FS=' ST-FUNCIN1      00356000
              MOVE ST-FUNCIN1   TO RETURN-CODE
              PERFORM ROT-ABEND
                 THRU ROT-ABEND-EXIT
           ELSE
      ...
      *----                                                             00358000
       1010-LER-FUNCIN2.                                                00359000
           ...
           IF ST-FUNCIN2 NOT EQUAL 0 AND WSS-EOF2 NOT = 'Y' THEN        00354000
              DISPLAY 'COBOL090 - ERRO READ FUNCI  FS=' ST-FUNCIN2      00356000
              MOVE ST-FUNCIN2   TO RETURN-CODE
              PERFORM ROT-ABEND
                 THRU ROT-ABEND-EXIT
           ELSE
      ...
      *----                                                             00510000
       4002-FECHAR-FUNCI.                                               00520000
           ...
           IF ST-FUNCIN1 NOT EQUAL 0 THEN
              DISPLAY 'COBOL090 - ERRO CLOSE FUNCI FS=' ST-FUNCIN1
              MOVE ST-FUNCIN1   TO RETURN-CODE
              PERFORM ROT-ABEND
                 THRU ROT-ABEND-EXIT
           END-IF.
           ...
           IF ST-FUNCIN2 NOT EQUAL 0 THEN
              DISPLAY 'COBOL090 - ERRO CLOSE FUNCI FS=' ST-FUNCIN2
              MOVE ST-FUNCIN2   TO RETURN-CODE
              PERFORM ROT-ABEND
                 THRU ROT-ABEND-EXIT
           END-IF.
           ...
           IF ST-FUNCOUT NOT EQUAL 0 THEN
              DISPLAY 'COBOL090 - ERRO CLOSE RELATFUN FS=' ST-FUNCOUT
              MOVE ST-FUNCOUT   TO RETURN-CODE
              PERFORM ROT-ABEND
                 THRU ROT-ABEND-EXIT
           END-IF.
